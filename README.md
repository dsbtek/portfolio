...
A modern, responsive portfolio website built with Next.js for the frontend and Flask for the backend. Features include a blog system, project showcase, and contact form functionality.
